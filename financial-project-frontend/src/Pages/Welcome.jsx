...
export function Welcome() {
  ...
  return ( 
  <div className="bg-gradient-to-b from-white to-gray-300 min-h-screen">
    <div className="">
      <NavBar/>
      {/* Hero Section */}
      <div className="">
    ...
    <div className="flex flex-wrap items-center justify-center">
      ...
      <div className="flex flex-col m-2 p-4 rounded-3xl shadow-lg max-w-md h-32 border bg-gradient-to-br from-sky-200 via-sky-300 to-sky-400">
