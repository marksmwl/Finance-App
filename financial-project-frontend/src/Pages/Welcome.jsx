...
export function Welcome() {
  ...
  <div className="bg-gradient-to-b from-white to-gray-300">
    <div className="">
      ...
      <div className="">
        <div className="p-2 mb-5">
          <h1 className="text-3xl font-bold mb-2 text-center">Welcome to Financier</h1>
    ...
    <div className="flex flex-col flex-wrap items-center justify-center">
      ...
      <div className="flex flex-col m-2 p-4 rounded shadow-lg max-w-md h-32 border bg-gradient-to-br from-sky-200 via-sky-300 to-sky-400">
